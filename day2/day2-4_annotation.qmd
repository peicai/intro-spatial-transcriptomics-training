...
Sample barcodes, sequended together with the probe sequences allow to pool multiple samples together and then demultiplex them. Here 2 pools of 2 samples (P2CRC/P4CRC, P3NAT/P5NAT) and 1 pool of 4 samples (P1CRC/P3CRC/P5CRC/P2NAT) were created and each pool was sequenced on multiple 10X Chromium lanes
:::

### Download the FLEX dataset

https://raw.githubusercontent.com/10XGenomics/HumanColonCancer_VisiumHD/refs/heads/main/MetaData/SingleCell_MetaData.csv.gz

https://ftp.ncbi.nlm.nih.gov/geo/series/GSE280nnn/GSE280311/suppl/
https://ftp.ncbi.nlm.nih.gov/geo/series/GSE280nnn/GSE280311/suppl/GSE280311_RAW.tar
```{r download}
options(timeout = 600)
