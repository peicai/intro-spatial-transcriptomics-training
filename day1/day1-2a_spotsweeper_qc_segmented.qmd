...
*NOTE*: This function will soon be deprecated and replaced by a faster function in the `scrapper` package (function `quickRnaQc.se()`).
...
p2 <- ggcells(sfe, aes(x=detected, y=subsets_Mito_percent*100)) + 
  geom_point() +
  geom_density_2d() +
  scale_x_log10() +
  geom_xsidehistogram() + 
...
sfe$qc_mito_prop <- sfe$subsets_Mito_percent > 0.1
