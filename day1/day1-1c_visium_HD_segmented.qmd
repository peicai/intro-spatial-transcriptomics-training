...
## Import into a SpatialExperiment object and subsetting
...
TO DO: import other segmentations masks? Could be nice to see whihc bins overlap cell boundaries!
-->
...
```{r}
# The "cellseg" slot of the metadata is problematic, let's remove it ebcause it's now stored as colGeometry slot 
