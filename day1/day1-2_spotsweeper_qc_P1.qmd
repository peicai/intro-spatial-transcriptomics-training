...
spe <- loadHDF5SummarizedExperiment(dir="results/day1/", prefix="01.1_spe_P1_")
...
```{r}
saveHDF5SummarizedExperiment(spe, dir="results/day1", prefix="01.2_spe_P1_", replace=TRUE,
